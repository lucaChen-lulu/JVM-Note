...
public class StringExer {
    ...
    public void change(String str, char ch[]) { //str只是形参
        str = "test ok"; 				//这边加个this.str，成员变量才会指向"test ok"的地址
        ch[0] = 'b';
    }
...
<img src="img/0001-16404987586441.png">



<img src="img/0002-16404987620923.png">
...
<img src="img/0003-16404987641305.png">

<img src="img/0004-16404987666187.png">
...
JDK6结果：Exception in thread "main" java.lang.OutOfMemoryError: PerGen space

JDK8结果：Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
...
public class StringTest4 {
    public static void main(String[] args) {
        System.out.println();//2293（memory中字符串总量）
...
<img src="img/0010-164067218188916.png">
...
<img src="img/0011-164067217909614.png">
...
```java
    ...
    public void test3(){
        ...
        ② s.append("a")
        ③ s.append("b")
        ④ s.toString()  --> 类似于 new String("ab")，但不等价
...
6. 如何保证变量s指向的是字符串常量池中的数据呢？
   ...
   String s3 = new StringBuilder("hello").toString().intern();
   ```
...
/**
 * 题目：
 * new String("ab")会创建几个对象？看字节码，就知道是两个（前提条件：之前常量池内没有"ab")。
 *     一个对象是：new关键字在堆空间创建的
...
<img src="img/0012-164067217219212.png">
...
<img src="img/0013-164067216905610.png">



JDK7及后续版本，**注意大坑**

<img src="img/0014-16406721672478.png">
...
- jdk1.6中，将这个字符串对象尝试放入字符串池中。

  - 如果串池中有，则不会放入，并返回已有的串池的对象的地址。

  - 如果没有，会把此对象复制一份，放入串池，并返回串池中的对象地址。

- Jdk1.7起，将这个字符串对象尝试放入字符串池中。

  - 如果串池中有，则不会放入，并返回已有的串池的对象的地址。

  - 如果没有，会把此**对象的引用地址**复制一份，放入串池，并返回串池中的对象地址。
...
![image-20201116113423492](img/0015-16406721644806.png)

**JDK7/8**

<img src="img/0016-16406721624654.png">
...
public class StringExer2 {
    public static void main(String[] args) {
        String s1 = new String("a") + new String("b");//执行完后，不会在字符串常量池中生成"ab"
        s1.intern();
        String s2 = "ab";
        System.out.println(s1 == s2);//true
    }
